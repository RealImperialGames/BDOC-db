# -*- coding: utf-8 -*-
"""bdocdb module can be installed and configured from here"""
...
setup(
    ...
    description='Black Desert Database manager for community servers',
    long_description=read("README.rst"),
    author='Netzulo Open Source',
    author_email='netzuleando@gmail.com',
    url='https://github.com/RealImperialGames/BDOC-db.git',
    download_url=("https://github.com/RealImperialGames/"
                  "BDOC-db/tarball/v{}").format(
        VERSION),
    keywords=[
        'BlackDesert',
        'BlackDesertOnline',
